...
stations = [
    ...
    {"name": "2.- Su majestad el bolero",
        "url": "https://conectperu.com:7182/stream?icy=http"},
    {"name": "3.- Radio Viejitas",
        "url": "https://media.streamingradiomx.com/listen/viejitas/stream"},
    {"name": "4.- Besame Medellin",
        "url": "https://19213.live.streamtheworld.com/BESAME_MEDELLINAAC_SC?csegid=2000"},
    {"name": "5.- Cafe Romantico Radio",
        "url": "https://panel.retrolandigital.com/listen/cafe_romantico_radio/listen"},
    {"name": "6.- Baladas románticas en español",
        "url": "https://media.streamingradiomx.com/listen/romantica/on"},
    {"name": "7.- Fórmula Melódica", "url": "https://s2.yesstreaming.net:9085/stream"},
    {"name": "8.- Radio ritmo romantica",
        "url": "https://mdstrm.com/audio/6839e2376607bdf6b2fcde27/icecast.audio"},
    {"name": "9.- Romance 99.5", "url": "https://stream.zeno.fm/3avzkdt91rhvv"},
    {"name": "10.- Acerca de Amor",
        "url": "https://27163.live.streamtheworld.com/XHRHFMAAC_SC"},
    {"name": "11.- Boleros, Baladas y mas",
        "url": "https://stream.zeno.fm/vx4vcv5qyk8uv"},
    {"name": "12.- María Vargas Boleros por siempre",
        "url": "https://stream.zeno.fm/40f0h23f938uv"},
    {"name": "13.- 100 Boleros con aroma",
        "url": "https://stream.zeno.fm/lfonv1tnignuv"},
    {"name": "14.- Boleros de oro, plata y bronce",
        "url": "https://stream.zeno.fm/8mk5quawgs8uv"},
    ...
    {"name": "19.- Buenisima radio boleros",
        "url": "https://stream.zeno.fm/fbpd99sqkchvv"},
    {"name": "20.- Radio felicidad tríos y boleros",
        "url": "https://17843.live.streamtheworld.com/ACIR17_S01.mp3"},
]
...
# Header
st.markdown("<h1>BOLEROS ROMANTICOS<br>Radios Online</br></h1>",
            unsafe_allow_html=True)
...
with st.container():
    ...
    with col2:
        ...
        st.markdown(
            '<p style="color:black; margin-bottom: 8px; text-align: center;">Selecciona una radio para reproducir:</p>', unsafe_allow_html=True)
        ...
        st.markdown(
            f'<p style="text-align: center; margin-top: 10px; font-weight: bold; color: #333;">Reproduciendo: {st.session_state["current_station_name"]}</p>', unsafe_allow_html=True)
